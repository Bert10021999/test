...
const Home = ()=> {
    ...
    const handleTotal = () =>{
        // simple computation
        const totalFee = amount * 7.5;
        const receivableAmount = amount * 2;
        setFee(totalFee);
        setRAmount(receivableAmount);
    }
    return(
        <div>
        ...
        <div className="grid grid-cols-1 gap-4 w-full max-w-md bg-white bg-opacity-90 p-6 rounded-lg shadow-lg">
